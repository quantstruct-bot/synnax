...
events in your cluster's data. Ranges are the primary means for organizing and accessing
the data stored within Synnax, and can be used to correlate meta-data with channel telemetry.
...
Ranges can store arbitrary pieces of meta-data that describe important information about
...
[Python](/reference/python-client/ranges) and
TypeScript client libraries provide programmatic
interfaces. Ranges can also be managed in the [Synnax
Console](/reference/console/ranges).
