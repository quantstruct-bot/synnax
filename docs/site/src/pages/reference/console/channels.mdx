...
results, or any other time-ordered data.
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      <td>Is Index</td>
      <td>
        If true, the channel will be an [index
        channel](/reference/concepts/channels#index-channels). Otherwise, the channel
        will be a [data channel](/reference/concepts/channels#data-channels).
      </td>
    </tr>
    <tr>
      <td>Data Type</td>
      <td>
        What data type the channel stores. If the channel is an index channel, then the
        data type must be a timestamp.
      </td>
    </tr>
    <tr>
      <td>Index</td>
...
difference between the two types of channels is explained more in the [channel concepts
page](/reference/concepts/channels).
